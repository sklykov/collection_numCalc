# -*- coding: utf-8 -*-
"""
Chorda or "false position" method
...
plotMyAwesomeFunc(f.example1,a,b,nPoints) # plotting of 1st example of function
...
def Chorda(func,a:float,b:float,epsilon:float,digitRound:int,showIteration:bool):
    ...
    if (func(a)*func(b) < 0):
        ...
        while (abs(func(xChorda)) > epsilon):
            ...
            if showIteration: i += 1; print("Iteration step #",i,"Root approximation is: ",round(xChorda,digitRound+1))
...
xRoot = Chorda(f.example1,a,b,epsilon,digitRound,showIteration)
