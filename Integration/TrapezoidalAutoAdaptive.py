# -*- coding: utf-8 -*-
"""
Trapezoidal Rule with automative (adaptive) selection of integration step by adjusting integral sum calculation for each
...
"""Trapezoidal Integration implementation. It demands [a,b] of interval for integration; y - function or
...
def TrapezoidalAutoAdaptive(a:float,b:float,y,epsilon:float=0.01):
    if (a >= b):
